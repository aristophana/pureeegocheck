...
ro_criteria = [
    ...
    r"rc_cola_\d+",
    r"ijaka(\d|10)",
    r"taiko_no_tatsujin_\d+",
    r"bobberino\d+",
    r"\d+(rd|th|nd|st)_catgirl_division",
    r"switz_got_lazy_\d+",
    r"switz_\d+",
    r"sweeze_\d+",
    r"tls_\d+",
    r"flap_flap_boom_\d+",
    r"liliarchy_ancillary_\d+",
    r"lucklife_\d+",
    r"lurklife_\d+",
    r"wednesday_\d+",
    r"thursday_\d+",
    r"thorn\d+",
    r"wascoitan_?\d+",
    r"pineapple_on_pizza_is_good_\d+",
    r"foxes_\d+",
    "oversized_operativez_\d+",
    r"cretanja_garrison_\d+",
    ...
    r"yor_\d+",
    r"punch_from_mark_lee_\d+",
    r"upc_is_not_fast_\d+",
    r"beans_on_toast_\d+",
    r"bigred\d+",
    r"terberrinse_\d+",
    r"flame_of_chaos_\d+",
    ...
    r"fedaykin_\d+",
    r"blanket_stealer_\d+",
    r"brutal_honesty_\d+",
    r"meep\d+",
    r"dragoe_\d+(rd|th|nd|st)_army_division",
    r"kaf-\d+",
    r"notas_\d+(rd|th|nd|st)_puppet",
    f"ruby_{roman_numeral_regex}",
    r"aurum_riders_\d+(rd|th|nd|st)_treasury",
    r"a_crazy_person_\d+",
    r"bcc_\d+",
